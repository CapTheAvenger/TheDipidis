...
// Part of Hausi's Pokemon TCG Analysis
        ...
        //
        // Two views:
        //   - 'M4'  (legacy id, label "Current Meta"): live City League data
        //   - 'M3'  (legacy id, label "Past Meta"):    frozen snapshot at
        //                                              the last JP-set rotation
        //
        // The 'M3'/'M4' values are internal ids (kept for localStorage
        // back-compat) — they no longer refer to specific Pokémon sets.
        //
        // File pairs:
        ...
        async function loadCityLeagueData() {
            ...
            try {
                ...
                // 'M3' is the legacy internal id for "Past Meta" — the
                // frozen snapshot at the last JP-set rotation. Files were
                // renamed from `*_M3.csv` (manual archive) to `*_past.csv`
                // (auto-generated by the past scrapers) on 2026-05-23.
