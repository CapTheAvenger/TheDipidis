...
const BASE_PATH = './data/';
        ...
        const TAB_HELP_CONTENT_DE = {
            'city-league': {
                ...
                html: '<p>Zeigt Trends der Archetyp-Popularität aus japanischen City-League-Turnieren.</p><ul><li><strong>Diagramm:</strong> Verfolgt Deck-Archetypen über die Zeit</li><li><strong>Format-Filter:</strong> Wechsel zwischen M4 (aktuell) und M3 (Archiv)</li><li><strong>Legenden-Toggle:</strong> Archetypen ein- und ausblenden</li><li><strong>Deck-Builder-Sync:</strong> Archetyp oeffnen und direkt zur Deck-Analyse wechseln</li></ul>'
            },
            'city-league-analysis': {
                title: '\ud83e\udd85 City League Deck-Analyse',
                html: '<p>Durchsuche und analysiere einzelne Decklisten aus City-League-Turnieren.</p><ul><li><strong>Archetyp- und Datumsfilter:</strong> Daten schnell eingrenzen</li><li><strong>Deck Builder:</strong> Karten hinzufügen/entfernen und 60-Karten-Deck bauen</li><li><strong>Consistency Generate:</strong> Math.round auf den Pro-Karte-Schnitt avg-when-used + Largest-Remainder-Method + Reverse-LRM. Trifft exakt 60 Karten und matcht die Intuition (Poke Pad 2,8 \u2192 3, Lillie\'s 3,9 \u2192 4).</li><li><strong>Tech-Slots (max 10):</strong> Die Leiste über dem Deck-Grid laesst dich bis zu 10 Karten via Typeahead-Suche fixieren \u2014 sie fliessen als Force-Pins in Stage-0 vom nächsten Generate und überleben Reloads.</li><li><strong>Build vs ...:</strong> Button im Tech-Slot-Header. Ziel-Archetyp + Aggression (Mild / Standard / Heavy) wählen. TechAudit wählt Counter-Karten über aktive Bedrohungs-Kategorien und füllt die Tech-Slots automatisch \u2014 du siehst was gewählt wurde und kannst nachjustieren.</li><li><strong>\u2191 Max Seltenheit / \u2193 Low Seltenheit Toggle:</strong> Ein Klick wechselt alle Karten im gebauten Deck zwischen Low- und Max-Rarity-Prints. Label flippt, Reset bei jedem frischen Generate.</li><li><strong>Tech vs Normal Panel:</strong> Diff am Seitenende zwischen letztem Normal-Build und letztem Tech-Build für diesen Bereich. Drei Spalten (Ergaenzt / Entfernt / Mengenänderungen) + Score-Delta. Erscheint erst wenn beide Snapshots existieren.</li><li><strong>Seltenheits-Wechsler (\u2605):</strong> Prints direkt in Deck und Übersicht wechseln</li><li><strong>Exakter Print-Tausch:</strong> Wechsel aktualisiert den Deck-Eintrag (Set+Nummer)</li><li><strong>Deck kopieren:</strong> Export im Pokemon-TCG-Live-Format</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Karten-Aktionstasten:</p><ul><li>\u2661 <strong>Wunschliste</strong> \u2014 Karte zur Wunschliste hinzufügen/entfernen</li><li>+ <strong>Sammlung</strong> \u2014 Karte zur Sammlung hinzufügen (zeigt Anzahl)</li><li>\u2605 <strong>Andere Prints zeigen</strong> \u2014 Zu einem anderen Print derselben Karte wechseln</li><li>L <strong>Limitless Kartendetails</strong> \u2014 Karteninfos auf limitlesstcg.com ansehen</li><li>P <strong>Zum Proxy-Drucker</strong> \u2014 Karte in die Proxy-Druckliste senden</li><li>\u20ac <strong>Cardmarket</strong> \u2014 Karte auf Cardmarket suchen</li></ul>'
            },
            'current-meta': {
                title: '\ud83c\udfae Limitless-Online-Vergleich',
                html: '<p>Vergleicht Meta-Anteile von Archetypen zwischen verschiedenen Turnierquellen.</p><ul><li><strong>Nebeneinander-Vergleich:</strong> Online vs. Turnierergebnisse</li><li><strong>Diagramme:</strong> Kreis- und Balkenansichten</li><li><strong>Meta-Share %:</strong> Schnellüberblick zur Popularität</li><li><strong>Fallback:</strong> Fehlt current_meta_card_data.csv, nutzt die App automatisch tournament_cards_data_cards.csv</li></ul>'
            },
            'current-analysis': {
                title: '\ud83d\udcc8 Aktuelle-Meta Deck-Analyse',
                html: '<p>Analysiere Decklisten aus aktuellen Limitless-Online-Turnieren.</p><ul><li><strong>Archetyp-Filter:</strong> Decks nach Archetyp durchsuchen</li><li><strong>Kartenverteilung:</strong> Meistgespielte Karten und Nutzung</li><li><strong>Deck Builder:</strong> Decks interaktiv bauen und anpassen</li><li><strong>Consistency Generate:</strong> Math.round auf den Pro-Karte-Schnitt avg-when-used + Largest-Remainder + Reverse-LRM. Summiert exakt auf 60 und matcht die UI-Werte (Poke Pad 2,8 \u2192 3, Lillie\'s 3,9 \u2192 4, Ultra Ball 2,3 \u2192 2 mit möglichem LRM-Bump).</li><li><strong>Tech-Slots (max 10):</strong> Die Leiste über dem Deck-Grid laesst dich bis zu 10 Karten per Typeahead fixieren \u2014 werden als Force-Pins in Stage-0 vom nächsten Generate eingebaut. Persistiert in localStorage.</li><li><strong>Build vs ...:</strong> Modal neben dem Generate-Button. Ziel-Archetyp + Aggression wählen. TechAudit füllt die Tech-Slots automatisch mit den besten Counter-Karten über aktive Bedrohungs-Kategorien (Hand Disruption, Ability Lock, Retreat Lock, Bench Damage etc.).</li><li><strong>\u2191 Max Seltenheit / \u2193 Low Seltenheit Toggle:</strong> Ein Klick wechselt alle Karten im gebauten Deck zwischen Low- und Max-Rarity-Prints. Bidirektional. Reset bei jedem frischen Generate.</li><li><strong>Tech vs Normal Panel:</strong> Diff am Seitenende zwischen letztem Normal- und Tech-Build \u2014 Ergaenzt / Entfernt / Mengenänderungen + Score-Delta. Erscheint nur wenn beide Snapshots existieren.</li><li><strong>Seltenheits-Wechsler (\u2605):</strong> Internationale Prints mit einem Klick wechseln</li><li><strong>Combined Variants:</strong> Prints derselben Karte (z.B. Riolu MEG 76 = Riolu ASC 112) werden automatisch zusammengeführt \u2014 der Anteil zeigt die tatsaechliche Popularität. Card-Share ist auf 100% gekappt um Major-only Merge-Edge-Cases abzufangen.</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Karten-Aktionstasten:</p><ul><li>\u2661 <strong>Wunschliste</strong> \u2014 Karte zur Wunschliste hinzufügen/entfernen</li><li>+ <strong>Sammlung</strong> \u2014 Karte zur Sammlung hinzufügen (zeigt Anzahl)</li><li>\u2605 <strong>Andere Prints zeigen</strong> \u2014 Zu einem anderen Print derselben Karte wechseln</li><li>L <strong>Limitless Kartendetails</strong> \u2014 Karteninfos auf limitlesstcg.com ansehen</li><li>P <strong>Zum Proxy-Drucker</strong> \u2014 Karte in die Proxy-Druckliste senden</li><li>\u20ac <strong>Cardmarket</strong> \u2014 Karte auf Cardmarket suchen</li></ul>'
            },
            'past-meta': {
                title: '\ud83c\udfc6 Vergangenes Turnier-Meta',
                html: '<p>Historische Turnierdaten großer Events (Regionals, EUIC, Worlds usw.).</p><ul><li><strong>Format-Filter:</strong> Nach Formatcode filtern (z. B. TEF-SCR, OBF-TWM)</li><li><strong>Quellen-Filter:</strong> Turniere/Regionen auswählen</li><li><strong>Volle Deck-Analyse:</strong> Inklusive Builder, Kopieren, Vergleichen und \u2605 Print-Wechsel</li><li><strong>Consistency Generate:</strong> Math.round + Largest-Remainder + Reverse-LRM landet exakt auf 60 Karten und respektiert den Pro-Karte-Schnitt avg-when-used.</li><li><strong>Tech-Slots (max 10):</strong> Leiste über dem Deck-Grid laesst dich bis zu 10 Karten per Typeahead in Stage-0 vom nächsten Generate fixieren.</li><li><strong>Build vs ...:</strong> Anti-Tech-Modal funktioniert auch hier \u2014 Archetyp + Aggression wählen, TechAudit füllt die Tech-Slots mit Counter-Karten.</li><li><strong>\u2191 Max Seltenheit / \u2193 Low Seltenheit Toggle:</strong> Ein-Klick-Wechsel zwischen Low- und Max-Rarity-Prints für das ganze gebaute Deck.</li><li><strong>Tech vs Normal Panel:</strong> Karten-Diff + Score-Delta am Seitenende zwischen letztem Normal- und Tech-Build.</li><li><strong>Historische Trends:</strong> Deck-Entwicklung über Formate verfolgen</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Karten-Aktionstasten:</p><ul><li>\u2661 <strong>Wunschliste</strong> \u2014 Karte zur Wunschliste hinzufügen/entfernen</li><li>+ <strong>Sammlung</strong> \u2014 Karte zur Sammlung hinzufügen (zeigt Anzahl)</li><li>\u2605 <strong>Andere Prints zeigen</strong> \u2014 Zu einem anderen Print derselben Karte wechseln</li><li>L <strong>Limitless Kartendetails</strong> \u2014 Karteninfos auf limitlesstcg.com ansehen</li><li>P <strong>Zum Proxy-Drucker</strong> \u2014 Karte in die Proxy-Druckliste senden</li><li>\u20ac <strong>Cardmarket</strong> \u2014 Karte auf Cardmarket suchen</li></ul>'
            },
            'cards': {
                title: '\ud83e\uddf0 Kartendatenbank',
                html: '<p>Durchsuche die vollständige Pokemon-TCG-Kartendatenbank.</p><ul><li><strong>Suche + Filter:</strong> Name, Set, Typ, Seltenheit, Meta-Filter</li><li><strong>Sortierung:</strong> Sets von neu nach alt</li><li><strong>Seltenheits-Wechsler (\u2605):</strong> Verfuegbare Prints schnell auswählen</li><li><strong>Sammlungsanzahl:</strong> Exakte Print-Zählung per Set+Nummer</li><li><strong>Wunschliste:</strong> Zielkarten mit \u2764 markieren</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Karten-Aktionstasten:</p><ul><li>\u2661 <strong>Wunschliste</strong> \u2014 Karte zur Wunschliste hinzufügen/entfernen</li><li>+ <strong>Sammlung</strong> \u2014 Karte zur Sammlung hinzufügen (zeigt Anzahl)</li><li>\u2605 <strong>Andere Prints zeigen</strong> \u2014 Zu einem anderen Print derselben Karte wechseln</li><li>L <strong>Limitless Kartendetails</strong> \u2014 Karteninfos auf limitlesstcg.com ansehen</li><li>P <strong>Zum Proxy-Drucker</strong> \u2014 Karte in die Proxy-Druckliste senden</li><li>\u20ac <strong>Cardmarket</strong> \u2014 Karte auf Cardmarket suchen</li></ul>'
            },
            'proxy': {
                title: '\ud83d\udda8\ufe0f Proxy-Drucker',
                html: '<p>Erstelle druckbare Proxy-Karten für Tests und Casual Play.</p><ul><li><strong>Deck importieren:</strong> Deckliste einfügen und Proxys automatisch erzeugen</li><li><strong>Manuell hinzufügen:</strong> Einzelkarten suchen und hinzufügen</li><li><strong>Drucklayout:</strong> Optimiert für 6,3cm x 8,8cm Kartenmaß</li><li><strong>Mengen anpassen:</strong> Exakte Kopienzahl je Karte setzen</li><li><strong>@media print:</strong> Browserdruck erzeugt A4-Seiten mit korrekten Kartengrößen</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Seiten-Buttons:</p><ul><li>+ / \u2013 <strong>Menge</strong> \u2014 Kopienzahl pro Karte erhöhen oder verringern</li><li>\u2716 <strong>Entfernen</strong> \u2014 Karte aus der Proxy-Liste löschen</li><li><strong>Deck importieren</strong> \u2014 Komplette Deckliste einfügen, alle Karten laden</li><li><strong>Alle löschen</strong> \u2014 Alle Karten aus der Proxy-Liste entfernen</li><li><strong>Drucken</strong> \u2014 Proxy-Bogen an den Browserdruck senden</li></ul>'
            },
            'profile': {
                title: '\ud83d\udc64 Benutzerprofil',
                html: '<p>Verwalte deine Sammlung, gespeicherte Decks und Einstellungen.</p><ul><li><strong>Meine Sammlung:</strong> Exakte Print-Anzahlen (Set+Nummer) mit Firebase-Sync</li><li><strong>Dex-Import:</strong> CSV-Import mit Setnamen-Mapping und nummernbasierter Erkennung</li><li><strong>Meine Decks:</strong> Badge pro Karte zeigt exakte Besitzanzahl für diesen Print</li><li><strong>\u2728 Indikator:</strong> Zeigt weitere internationale Prints derselben Karte in deiner Sammlung</li><li><strong>Seltenheits-Wechsler (\u2605):</strong> Prints direkt in gespeicherten Deckkarten wechseln</li><li><strong>Vergleich (\u2696\ufe0f):</strong> Quelle wählen (Limitless/PTCGL oder gespeicherte Decks)</li><li><strong>Vergleichsmodus:</strong> Funktional (Prints zusammengeführt) oder exakter Print</li><li><strong>Wunschliste + Einstellungen:</strong> Ziele und Kontooptionen verwalten</li></ul><hr style="margin:14px 0;border:none;border-top:1px solid #ddd;"><p style="font-weight:700;margin:0 0 6px;">Karten-Aktionstasten:</p><ul><li>\u2661 <strong>Wunschliste</strong> \u2014 Karte zur Wunschliste hinzufügen/entfernen</li><li>+ <strong>Sammlung</strong> \u2014 Karte zur Sammlung hinzufügen (zeigt Anzahl)</li><li>\u2605 <strong>Andere Prints zeigen</strong> \u2014 Zu einem anderen Print derselben Karte wechseln</li><li>L <strong>Limitless Kartendetails</strong> \u2014 Karteninfos auf limitlesstcg.com ansehen</li><li>P <strong>Zum Proxy-Drucker</strong> \u2014 Karte in die Proxy-Druckliste senden</li><li>\u20ac <strong>Cardmarket</strong> \u2014 Karte auf Cardmarket suchen</li></ul>'
            },
            'calculator': {
                title: '\ud83e\uddee Wahrscheinlichkeitsrechner',
                html: '<p>Berechnet Zieh-, Preis- und Topdeck-Wahrscheinlichkeiten für dein Deck.</p><ul><li><strong>Zug-Chance:</strong> Wahrscheinlichkeit, mindestens eine Kopie in gezogenen Karten zu sehen</li><li><strong>Preiskarten-Chance:</strong> Wahrscheinlichkeit, dass mindestens eine Kopie in den Preisen liegt</li><li><strong>Topdeck-Chance:</strong> Wahrscheinlichkeit, dass der nächste Draw deine Zielkarte ist</li><li><strong>Eingaben:</strong> Kopien im Deck, gezogene Karten, bereits auf der Hand</li></ul>'
            },
            'tutorial': {
                title: '\ud83d\udcd6 Anleitung',
                html: '<p>Umfassender Guide zu allen Funktionen dieser Website.</p><ul><li><strong>Tab-Guides:</strong> Detaillierte Hinweise zu jedem Bereich</li><li><strong>Neueste Änderungen:</strong> Tech-Slots (bis zu 10 forcierte Karten), Multi-Source \u201eBuild vs ..." Anti-Tech-Modal, Tech-vs-Normal Compare-Panel am Seitenende, bidirektionaler \u2191 Max Seltenheit \u2194 \u2193 Low Seltenheit Toggle, Math.round + Reverse-LRM im Consistency Generator (matcht den Pro-Karte-Schnitt aus der UI), und der 100%-Cap für Major-only Card-Share Merges.</li><li><strong>Tech-Slots:</strong> Über jedem Deck-Builder-Grid \u2014 Typeahead-Picker, max 10, persistiert über Reloads. Karten in den Slots werden als Force-Pins in Stage-0 vom nächsten Consistency Generate eingebaut.</li><li><strong>Build vs ...:</strong> Ziel-Archetyp + Aggression-Preset wählen. Die TechAudit-Pipeline füllt deine Tech-Slots automatisch mit den besten Counter-Karten über aktive Bedrohungs-Kategorien.</li><li><strong>Tech vs Normal:</strong> Panel am Seitenende \u2014 Diff zwischen deinem letzten Normal-Build und letzten Tech-Build für denselben Bereich. Drei Spalten + Score-Delta.</li><li><strong>Vergleichshinweise:</strong> Live-Parser-Vorschau + Funktional/Exakt-Modi</li><li><strong>Import-Hinweise:</strong> Dex-CSV Setnamen- und Setnummern-Matching erklaert</li></ul>'
            },
            'meta-analysis-hub': {
                title: '\ud83d\udcca Meta- & Deck-Analyse Hub',
                html: '<p>Der Startpunkt f\u00fcr alle Meta- und Deck-Daten-Ansichten. Tippe eine Kategorie-Kachel an, um in eine der sechs Datenquellen einzutauchen.</p><ul><li><strong>City League Meta:</strong> W\u00f6chentlicher japanischer Meta-Snapshot \u2014 Archetyp-Anteile, Tier-Liste, Top-Varianten gruppiert nach Haupt-Pok\u00e9mon.</li><li><strong>Deck Analyse (Japan):</strong> Karten-\u00dcbersicht + Pro-Karte-Statistiken f\u00fcr jeden City-League-Archetyp.</li><li><strong>Current Meta (Global):</strong> Limitless-Online Tier-Liste, Top-Archetypen, Climbers/Fallers, Full-Comparison-Tabelle.</li><li><strong>Deck Analyse (Global):</strong> Gleiche Tiefe wie der Japan-Tab, aber f\u00fcr globale Online-Turniere \u2014 plus Cooking Mode f\u00fcr Power-User-Fusion + Matchup-Analyse.</li><li><strong>Past Meta:</strong> Historischer Labs-only-Snapshot der vorherigen Rotation. Ideal als Baseline um aktuelle Decks gegen den Format-Start zu vergleichen.</li><li><strong>Meta Call:</strong> Vorhergesagter Meta-Anteil f\u00fcr dein n\u00e4chstes Turnier. Kombiniert Online + Major-Daten mit deinen eigenen Sch\u00e4tzungen.</li></ul>'
            },
            'meta-call': {
                title: '\ud83d\udcca Meta Call',
                html: '<p>Sage voraus, wie das Meta auf deinem n\u00e4chsten Turnier aussieht \u2014 und tune die Vorhersage mit deinem Bauchgef\u00fchl.</p><ul><li><strong>Zwei Varianten:</strong> <em>Current</em> kombiniert die noch laufende Limitless-Online-Rotation mit den neuesten Majors, wendet einen Konzentrations-Counter an und d\u00e4mpft Hype. <em>Past</em> zeigt den eingefrorenen Labs-only-Snapshot der vorherigen Rotation \u2014 eine saubere Baseline.</li><li><strong>Override-Panel:</strong> Push einzelne Archetypen hoch oder runter. Deine Overrides werden lokal gespeichert und beim n\u00e4chsten Besuch wieder angewendet.</li><li><strong>Finaler Anteil:</strong> Drei-Spalten-Ansicht (Online / Gesch\u00e4tzt / Final) damit du genau siehst, wo deine Overrides die Vorhersage verschoben haben.</li><li><strong>Erwartete Begegnungen:</strong> Pro-Runde Begegnungsrate gegen jeden Archetyp, gewichtet nach deinem finalen Anteil.</li><li><strong>Empfehlungen:</strong> Kombinierter Archetyp-Anteil + Vanilla-Winrate deines Builds gegen das vorhergesagte Meta. Enth\u00e4lt ein \u201eYour Build vs Vanilla"-Panel.</li><li><strong>Telegram-Bot:</strong> /metacall im Bot schickt sowohl die Per-Varianten- als auch die Familien-gruppierten PNGs dieses Dashboards \u2014 gleiche Daten, direkt nutzbar in einem Turnier-Chat.</li></ul>'
            },
            'tech-lab': {
                title: '\ud83d\udd2c Tech Lab',
         ...
         * sie samt Zusicherungen zu löschen.
         *
         ...
         * eigentliche Problem; löschen haette die beiden ungeprueften
