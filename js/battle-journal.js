(function() {
    ...
    function saveBattleJournalDraft(draft) {
        ...
        if (!safeDraft.ownDeck && !safeDraft.opponentArchetype && !safeDraft.turnOrder && !safeDraft.result) {
    ...
    function renderDeckChoices() {
        ...
        const ownDeckChoices = uniqueSorted([
                ...
                return `
                    <div class="battle-journal-pending-item">
                        <div class="battle-journal-pending-main">
                            ...
                            <div class="battle-journal-pending-meta">${escapeHtml(turnText)} · ${new Date(entry.createdAtMs || Date.now()).toLocaleString(getLang() === 'de' ? 'de-DE' : 'en-GB', { day: '2-digit', month: '2-digit', hour: '2-digit', minute: '2-digit' })}</div>
                        </div>
