 ...
 *
 * Loaded as a regular <script>; exposes `window.dom` as a namespace
 * object, plus declares `dom` as a free global via types/globals.d.ts.
 */
...
(function () {
  ...
  const api = { el, input, select, textarea, button, queryAs, queryInput, querySelect, asHTML };
  /** @type {any} */ (window).dom = api;
})();
