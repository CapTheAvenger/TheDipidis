// @ts-check
// (Wave-1 L2.15: converted to ES module. localforage + window.dataUrl remain
//  as global `any` deps until those are migrated too. The modules-bundle
//  footer re-attaches `cardDataCache` to window for legacy callers.)
