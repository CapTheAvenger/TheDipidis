 ...
 *
 * Wave-1 L2.12 — converted from legacy IIFE to a proper ES module.
 * The modules-bundle footer exposes the named exports as
 * window.openInShowdownFromBuilder / window.copyDeckAndOpenShowdown /
 * window.openShowdownExternal for HTML inline onclick handlers.
 */
...
export { openInShowdownFromBuilder, copyDeckAndOpenShowdown, openShowdownExternal };
